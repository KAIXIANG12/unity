...
namespace Watermelon
{
    ...
    public class UIMainMenuButton
    {
        ...
        public void Show(bool immediately = false)
        {
            ...
            showHideCase = rect.DOAnchoredPosition(rect.anchoredPosition.SetX(savedRectPosX), showHideDuration).EnableCustomEasing(showStoreAdButtonsCurve);
        }
        ...
        public void Hide(bool immediately = false)
        {
            ...
            showHideCase = rect.DOAnchoredPosition(rect.anchoredPosition.SetX(rectXPosBehindOfTheScreen), showHideDuration).EnableCustomEasing(hideStoreAdButtonsCurve);
        }
    }
}
