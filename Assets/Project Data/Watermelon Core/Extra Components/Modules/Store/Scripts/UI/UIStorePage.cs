...
namespace Watermelon.Store
{
    public class UIStorePage : UIPage
    {
        ...
        public override void Initialise()
        {
            ...
            coinsCurrency = CurrenciesController.GetCurrency(Currency.Type.Gems);
        }
        ...
        public override void PlayShowAnimation()
        {
            ...
            coinsForAdsCurrencyImage.sprite = coinsCurrency.Icon;
        }
        ...
        public void GetCoinsForAdsButton()
        {
            AdsManager.ShowRewardBasedVideo((bool success) =>
            {
                if (success)
                {
                    CurrencyCloud.SpawnCurrency("Gems", coinsForAdsText.rectTransform, coinsText.rectTransform, 20, "", () =>
                    {
                        CurrenciesController.Add(Currency.Type.Gems, StoreController.CoinsForAdsAmount);
