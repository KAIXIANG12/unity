...
namespace Watermelon.Store
{
    ...
    public class StoreDatabaseEditor : WatermelonEditor
    {
        ...
        {
            base.Styles();
            productSectionStyle = new GUIStyle(EditorStylesExtended.editorSkin.box);
        ...
        {
            EditorGUILayout.BeginVertical(EditorStylesExtended.editorSkin.box, GUILayout.ExpandHeight(false));
        ...
        {
            tabsRect = EditorGUILayout.BeginVertical(EditorStylesExtended.editorSkin.box, GUILayout.ExpandHeight(false));
    ...
    public class TabTypePopupWindow : PopupWindowContent
    {
        ...
        private void UpdateEnum()
        {
            ...
            stringBuilder.Append("namespace Watermelon.Store");
            stringBuilder.AppendLine();
